...
// Alteração do SQL para incluir a junção com a tabela 'usuarios'
$sql = "SELECT tarefas.tar_codigo, tarefas.setor, tarefas.prioridade, tarefas.descricao, tarefas.status, usuarios.nome as usuario_nome 
        FROM tarefas 
        LEFT JOIN usuarios ON tarefas.usu_codigo = usuarios.usu_codigo";
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>Descrição</th>
                    <th>Status</th>
                    <th>Usuário</th> <!-- Nova coluna para exibir o nome do usuário -->
                    <th>Ações</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $row['usuario_nome']; ?></td> <!-- Exibe o nome do usuário -->
                    <td class="actions">
